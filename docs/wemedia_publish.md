...
# 3.Article (new/modified) save process
...
## c) After the article review is successful, it is necessary to add article data to the article library of the app
...
## g) Filter out sensitive words in the image text
